...
Engineering, 207-232. Springer Verlag, New York.

Venket Raghavan (2021). seqvisr: Biological Sequence Visualization
Functions in R. R package version 0.2.5.
<https://github.com/vragh/seqvisr>

U. Bodenhofer, E. Bonatesta, C. Horejs-Kainrath, and S. Hochreiter
(2015) msa: an R package for multiple sequence alignment. Bioinformatics
